      ...
      <div className="container p-5">
        <MotionDiv>
          <div className="section-title text-center relative pb-3 mb-5 mx-auto max-w-xl">
            <h5 className="font-bold text-2xl text-gray-900 dark:text-white">Why Choose Us</h5>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <div className="space-y-5 p-5">
            <MotionDiv delay={0.2}>
              ...
              <h4 className="text-2xl font-bold text-gray-900 dark:text-white">Expert Team</h4>
              <p>
            ...
            <MotionDiv delay={0.4}>
              ...
              <h4 className="text-2xl font-bold text-gray-900 dark:text-white">Confidentiality Assured</h4>
          ...
          <MotionDiv delay={0.6}>
            <div className="h-[70vh] relative">
              <img src="https://images.pexels.com/photos/1998306/pexels-photo-1998306.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="Feature" className="w-full h-full object-cover rounded" />
            </div>
          </MotionDiv>
          {/* Right Column */}
          <div className="space-y-5 p-5">
            <MotionDiv delay={0.8}>
              ...
              <h4 className="text-2xl font-bold text-gray-900 dark:text-white">Cost-Effective Solutions</h4>
            ...
            <MotionDiv delay={1.0}>
              ...
              <h4 className="text-2xl font-bold text-gray-900 dark:text-white">Customized Services</h4>
